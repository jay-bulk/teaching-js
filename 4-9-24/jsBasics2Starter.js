...
function getRandomQuote() {
  let aLength = myQuotes.length;
  let aIndex = Math.floor(Math.random() * aLength);

  return myQuotes[aIndex];
}

function updateRandomQuote() {
  let aQuote = getRandomQuote();
  document.querySelector("#random-quote-text").innerHTML =
    '"Quote: ' + aQuote.quote + '"';
  document.querySelector("#random-quote-movie").innerHTML =
    `"Movie: ${aQuote.movie}"`;
}

document.getElementById("new-quote").onclick = updateRandomQuote;
